...
def logout():
    ...
    # removes temporary session exerciseplan
    session.pop("tempexerciseplan", None)
    session.pop("savedmealplan", None)  # removes saved session mealplan
    # removes saved session exerciseplan
...
def listitems():
    ...
    if request.method == "POST":
        ...
        if newfoodcalories1 != None and newfoodcalories1 != "":
            newfood1["nutritional_values"]["calories"] = float(
                newfoodcalories1)
        ...
        if newfoodcalories2 != None and newfoodcalories2 != "":
            newfood2["nutritional_values"]["calories"] = float(
                newfoodcalories2)
        ...
        if newfoodcalories3 != None and newfoodcalories3 != "":
            newfood3["nutritional_values"]["calories"] = float(
                newfoodcalories3)
