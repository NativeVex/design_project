...
class DataStructures:
    ...
    def exercise_reqs():
        ...
        return skeleton
    def getcurrenthealthrequirementsfromdb():
    # Hard coded exercises for now
        jsonstring = DataStructures.nutritional_values()
        jsonstring["calories"]=7.6
        jsonstring["carbohydrate"]=8.2
        jsonstring["protein"]=9.7
        return jsonstring

    def getoldhealthrequirementsfromdb():
    # Hard coded exercises for now
        jsonstring = DataStructures.nutritional_values()
        jsonstring["calories"]=89.6
        jsonstring["carbohydrate"]=128.9
        jsonstring["protein"]=27.7
        return jsonstring